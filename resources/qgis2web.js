...
map.getView().fit([-1061498.085219, 5296360.478462, 1169531.352030, 6933902.171817], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Fish Stocking Locations in Alberta (2024)</h2>';
        return titleElement;
    })(),
